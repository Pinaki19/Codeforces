...
bool getAns(auto& a1,auto& a2,int k,int f,int c1,int c2){
    if(f>k){
        return c1==k/2 && c2==k/2;
    }
    if (c1>k/2 || c2>k/2 )
        return 0;
    bool r1=b_search(a1,f);
    bool r2=b_search(a2,f);
    if(r1&& r2){
        return getAns(a1, a2, k, f + 1, c1 + 1, c2) || getAns(a1, a2, k, f + 1, c1, c2+1);
    }else if(r1){
        return getAns(a1, a2, k, f + 1, c1 + 1, c2);
    }else if(r2){
        return getAns(a1, a2, k, f + 1, c1, c2 + 1);
    }else
        return false;
}
