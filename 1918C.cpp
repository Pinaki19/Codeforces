...
string binary(auto &a) { if(a==0){return "0000000000";} assert(a>=0);string s=bitset<128> (a).to_string(); elz(s);return s;}
struct phash{
...
// a[i]=0 & b[i]=1 ==> a-b-2^(i+1)
bool getbit(ll a,int i){
    return (a>>i)&1;
}
